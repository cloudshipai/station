...
import type { CodingStreamEvent, CodingResult, StreamEventType } from "../types";
...
export class EventPublisher {
  ...
  async stream(type: StreamEventType, data: Partial<Omit<CodingStreamEvent, "taskID" | "seq" | "timestamp" | "type">>): Promise<void> {
    this.seq++;
