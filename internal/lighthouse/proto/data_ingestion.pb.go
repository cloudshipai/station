...
type ProcessingOptions struct {
	...
	SchemaMode       SchemaMode `protobuf:"varint,3,opt,name=schema_mode,json=schemaMode,proto3,enum=lighthouse.v1.SchemaMode" json:"schema_mode,omitempty"` // How to handle schema evolution
	// Storage options
	...
	Compression     CompressionType `protobuf:"varint,5,opt,name=compression,proto3,enum=lighthouse.v1.CompressionType" json:"compression,omitempty"` // Compress large payloads
	...
	Priority        Priority `protobuf:"varint,8,opt,name=priority,proto3,enum=lighthouse.v1.Priority" json:"priority,omitempty"`          // Processing priority
...
type SystemHealth struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	Status             HealthStatus           `protobuf:"varint,1,opt,name=status,proto3,enum=lighthouse.v1.HealthStatus" json:"status,omitempty"`
	Message            string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
...
type AgentRunData struct {
	...
	Status        RunStatus              `protobuf:"varint,8,opt,name=status,proto3,enum=lighthouse.v1.RunStatus" json:"status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_internal_lighthouse_proto_data_ingestion_proto_rawDesc = "" +
	...
	"\x04data\x18\b \x01(\v2\x17.google.protobuf.StructR\x04data\x12J\n" +
	"\bmetadata\x18\t \x03(\v2..lighthouse.v1.IngestDataRequest.MetadataEntryR\bmetadata\x12B\n" +
	...
	"\x11records_processed\x18\x04 \x01(\x05R\x10recordsProcessed\x12K\n" +
	"\x11validation_errors\x18\x05 \x03(\v2\x1e.lighthouse.v1.ValidationErrorR\x10validationErrors\x12:\n" +
	"\ametrics\x18\x06 \x01(\v2 .lighthouse.v1.ProcessingMetricsR\ametrics\"\x87\x01\n" +
	"\x12IngestBatchRequest\x12:\n" +
	"\arecords\x18\x01 \x03(\v2 .lighthouse.v1.IngestDataRequestR\arecords\x125\n" +
	"\aoptions\x18\x02 \x01(\v2\x1b.lighthouse.v1.BatchOptionsR\aoptions\"\xd2\x02\n" +
	...
	"\n" +
	"record_ids\x18\x06 \x03(\tR\trecordIds\x121\n" +
	"\x06errors\x18\a \x03(\v2\x19.lighthouse.v1.BatchErrorR\x06errors\x12:\n" +
	"\ametrics\x18\b \x01(\v2 .lighthouse.v1.ProcessingMetricsR\ametrics\"\xf2\x03\n" +
	"\x11ProcessingOptions\x12+\n" +
	"\x11strict_validation\x18\x01 \x01(\bR\x10strictValidation\x12,\n" +
	"\x12auto_create_schema\x18\x02 \x01(\bR\x10autoCreateSchema\x12:\n" +
	"\vschema_mode\x18\x03 \x01(\x0e2\x19.lighthouse.v1.SchemaModeR\n" +
	"schemaMode\x12*\n" +
	"\x11store_raw_payload\x18\x04 \x01(\bR\x0fstoreRawPayload\x12@\n" +
	"\vcompression\x18\x05 \x01(\x0e2\x1e.lighthouse.v1.CompressionTypeR\vcompression\x12\x19\n" +
	"\bttl_days\x18\x06 \x01(\x05R\attlDays\x12)\n" +
	"\x10async_processing\x18\a \x01(\bR\x0fasyncProcessing\x123\n" +
	"\bpriority\x18\b \x01(\x0e2\x17.lighthouse.v1.PriorityR\bpriority\x12\x12\n" +
	...
	"\factual_value\x18\x05 \x01(\v2\x14.google.protobuf.AnyR\vactualValue\"\xa1\x01\n" +
	"\n" +
	"BatchError\x12!\n" +
	"\frecord_index\x18\x01 \x01(\x05R\vrecordIndex\x12K\n" +
	"\x11validation_errors\x18\x02 \x03(\v2\x1e.lighthouse.v1.ValidationErrorR\x10validationErrors\x12#\n" +
	...
	"\x05since\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x05since\"\xc6\x01\n" +
	"\x17IngestionStatusResponse\x123\n" +
	"\x05stats\x18\x01 \x01(\v2\x1d.lighthouse.v1.IngestionStatsR\x05stats\x12A\n" +
	"\fsource_stats\x18\x02 \x03(\v2\x1e.lighthouse.v1.DataSourceStatsR\vsourceStats\x123\n" +
	"\x06health\x18\x03 \x01(\v2\x1b.lighthouse.v1.SystemHealthR\x06health\"\x82\x04\n" +
	...
	" \x01(\tR\x10lastErrorMessage\"\xec\x02\n" +
	"\fSystemHealth\x123\n" +
	"\x06status\x18\x01 \x01(\x0e2\x1b.lighthouse.v1.HealthStatusR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12*\n" +
	...
	"\x12processing_threads\x18\b \x01(\x05R\x11processingThreads\"\xb9\x02\n" +
	...
	"\x0ebilling_period\x18\a \x01(\tR\rbillingPeriod\x12&\n" +
	"\x04tags\x18\b \x03(\v2\x12.lighthouse.v1.TagR\x04tags\x122\n" +
	"\x05specs\x18\t \x01(\v2\x1c.lighthouse.v1.ResourceSpecsR\x05specs\"\xb7\x02\n" +
	...
	"tokenUsage\x120\n" +
	"\x06status\x18\b \x01(\x0e2\x18.lighthouse.v1.RunStatusR\x06status\"\xcd\x01\n" +
	"\x0fHealthCheckData\x12\x1c\n" +
	"\tcomponent\x18\x01 \x01(\tR\tcomponent\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\x12(\n" +
	"\x10response_time_ms\x18\x03 \x01(\x01R\x0eresponseTimeMs\x125\n" +
	"\ametrics\x18\x04 \x03(\v2\x1b.lighthouse.v1.HealthMetricR\ametrics\x12#\n" +
	...
	"\x10additional_specs\x18\x05 \x03(\v21.lighthouse.v1.ResourceSpecs.AdditionalSpecsEntryR\x0fadditionalSpecs\x1aB\n" +
	...
	"\x14RUN_STATUS_CANCELLED\x10\x052\xfd\x02\n" +
	"\x14DataIngestionService\x12Q\n" +
	"\n" +
...
var file_internal_lighthouse_proto_data_ingestion_proto_goTypes = []any{
	...
	(HealthStatus)(0),               // 3: lighthouse.v1.HealthStatus
	(RunStatus)(0),                  // 4: lighthouse.v1.RunStatus
	(*IngestDataRequest)(nil),       // 5: lighthouse.v1.IngestDataRequest
	(*IngestDataResponse)(nil),      // 6: lighthouse.v1.IngestDataResponse
	(*IngestBatchRequest)(nil),      // 7: lighthouse.v1.IngestBatchRequest
	(*IngestBatchResponse)(nil),     // 8: lighthouse.v1.IngestBatchResponse
	(*ProcessingOptions)(nil),       // 9: lighthouse.v1.ProcessingOptions
	(*BatchOptions)(nil),            // 10: lighthouse.v1.BatchOptions
	(*ValidationError)(nil),         // 11: lighthouse.v1.ValidationError
	(*BatchError)(nil),              // 12: lighthouse.v1.BatchError
	(*ProcessingMetrics)(nil),       // 13: lighthouse.v1.ProcessingMetrics
	(*IngestionStatusRequest)(nil),  // 14: lighthouse.v1.IngestionStatusRequest
	(*IngestionStatusResponse)(nil), // 15: lighthouse.v1.IngestionStatusResponse
	(*IngestionStats)(nil),          // 16: lighthouse.v1.IngestionStats
	(*DataSourceStats)(nil),         // 17: lighthouse.v1.DataSourceStats
	(*SystemHealth)(nil),            // 18: lighthouse.v1.SystemHealth
	(*FinOpsCostData)(nil),          // 19: lighthouse.v1.FinOpsCostData
	(*AgentRunData)(nil),            // 20: lighthouse.v1.AgentRunData
	(*HealthCheckData)(nil),         // 21: lighthouse.v1.HealthCheckData
	(*Tag)(nil),                     // 22: lighthouse.v1.Tag
	(*ResourceSpecs)(nil),           // 23: lighthouse.v1.ResourceSpecs
	(*ToolCall)(nil),                // 24: lighthouse.v1.ToolCall
	(*TokenUsage)(nil),              // 25: lighthouse.v1.TokenUsage
	(*HealthMetric)(nil),            // 26: lighthouse.v1.HealthMetric
	nil,                             // 27: lighthouse.v1.IngestDataRequest.MetadataEntry
	nil,                             // 28: lighthouse.v1.ResourceSpecs.AdditionalSpecsEntry
...
var file_internal_lighthouse_proto_data_ingestion_proto_depIdxs = []int32{
	...
	30, // 3: lighthouse.v1.IngestDataRequest.timestamp:type_name -> google.protobuf.Timestamp
	30, // 4: lighthouse.v1.IngestDataRequest.ingested_at:type_name -> google.protobuf.Timestamp
	9,  // 5: lighthouse.v1.IngestDataRequest.processing_options:type_name -> lighthouse.v1.ProcessingOptions
	11, // 6: lighthouse.v1.IngestDataResponse.validation_errors:type_name -> lighthouse.v1.ValidationError
	13, // 7: lighthouse.v1.IngestDataResponse.metrics:type_name -> lighthouse.v1.ProcessingMetrics
	5,  // 8: lighthouse.v1.IngestBatchRequest.records:type_name -> lighthouse.v1.IngestDataRequest
	10, // 9: lighthouse.v1.IngestBatchRequest.options:type_name -> lighthouse.v1.BatchOptions
	12, // 10: lighthouse.v1.IngestBatchResponse.errors:type_name -> lighthouse.v1.BatchError
	13, // 11: lighthouse.v1.IngestBatchResponse.metrics:type_name -> lighthouse.v1.ProcessingMetrics
	0,  // 12: lighthouse.v1.ProcessingOptions.schema_mode:type_name -> lighthouse.v1.SchemaMode
	1,  // 13: lighthouse.v1.ProcessingOptions.compression:type_name -> lighthouse.v1.CompressionType
	2,  // 14: lighthouse.v1.ProcessingOptions.priority:type_name -> lighthouse.v1.Priority
	31, // 15: lighthouse.v1.ValidationError.expected_value:type_name -> google.protobuf.Any
	31, // 16: lighthouse.v1.ValidationError.actual_value:type_name -> google.protobuf.Any
	11, // 17: lighthouse.v1.BatchError.validation_errors:type_name -> lighthouse.v1.ValidationError
	30, // 18: lighthouse.v1.IngestionStatusRequest.since:type_name -> google.protobuf.Timestamp
	16, // 19: lighthouse.v1.IngestionStatusResponse.stats:type_name -> lighthouse.v1.IngestionStats
	17, // 20: lighthouse.v1.IngestionStatusResponse.source_stats:type_name -> lighthouse.v1.DataSourceStats
	18, // 21: lighthouse.v1.IngestionStatusResponse.health:type_name -> lighthouse.v1.SystemHealth
	30, // 22: lighthouse.v1.IngestionStats.last_ingestion:type_name -> google.protobuf.Timestamp
	30, // 23: lighthouse.v1.DataSourceStats.last_successful_ingestion:type_name -> google.protobuf.Timestamp
	30, // 24: lighthouse.v1.DataSourceStats.last_failed_ingestion:type_name -> google.protobuf.Timestamp
	3,  // 25: lighthouse.v1.SystemHealth.status:type_name -> lighthouse.v1.HealthStatus
	22, // 26: lighthouse.v1.FinOpsCostData.tags:type_name -> lighthouse.v1.Tag
	23, // 27: lighthouse.v1.FinOpsCostData.specs:type_name -> lighthouse.v1.ResourceSpecs
	24, // 28: lighthouse.v1.AgentRunData.tool_calls:type_name -> lighthouse.v1.ToolCall
	25, // 29: lighthouse.v1.AgentRunData.token_usage:type_name -> lighthouse.v1.TokenUsage
	4,  // 30: lighthouse.v1.AgentRunData.status:type_name -> lighthouse.v1.RunStatus
	26, // 31: lighthouse.v1.HealthCheckData.metrics:type_name -> lighthouse.v1.HealthMetric
	28, // 32: lighthouse.v1.ResourceSpecs.additional_specs:type_name -> lighthouse.v1.ResourceSpecs.AdditionalSpecsEntry
	29, // 33: lighthouse.v1.ToolCall.parameters:type_name -> google.protobuf.Struct
	29, // 34: lighthouse.v1.ToolCall.result:type_name -> google.protobuf.Struct
	30, // 35: lighthouse.v1.ToolCall.timestamp:type_name -> google.protobuf.Timestamp
	5,  // 36: lighthouse.v1.DataIngestionService.IngestData:input_type -> lighthouse.v1.IngestDataRequest
	7,  // 37: lighthouse.v1.DataIngestionService.IngestBatch:input_type -> lighthouse.v1.IngestBatchRequest
	5,  // 38: lighthouse.v1.DataIngestionService.IngestStream:input_type -> lighthouse.v1.IngestDataRequest
	14, // 39: lighthouse.v1.DataIngestionService.GetIngestionStatus:input_type -> lighthouse.v1.IngestionStatusRequest
	6,  // 40: lighthouse.v1.DataIngestionService.IngestData:output_type -> lighthouse.v1.IngestDataResponse
	8,  // 41: lighthouse.v1.DataIngestionService.IngestBatch:output_type -> lighthouse.v1.IngestBatchResponse
	6,  // 42: lighthouse.v1.DataIngestionService.IngestStream:output_type -> lighthouse.v1.IngestDataResponse
	15, // 43: lighthouse.v1.DataIngestionService.GetIngestionStatus:output_type -> lighthouse.v1.IngestionStatusResponse
