...
const (
	DataIngestionService_IngestData_FullMethodName         = "/lighthouse.ingestion.v1.DataIngestionService/IngestData"
	DataIngestionService_IngestBatch_FullMethodName        = "/lighthouse.ingestion.v1.DataIngestionService/IngestBatch"
	DataIngestionService_IngestStream_FullMethodName       = "/lighthouse.ingestion.v1.DataIngestionService/IngestStream"
	DataIngestionService_GetIngestionStatus_FullMethodName = "/lighthouse.ingestion.v1.DataIngestionService/GetIngestionStatus"
)
...
var DataIngestionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "lighthouse.ingestion.v1.DataIngestionService",
