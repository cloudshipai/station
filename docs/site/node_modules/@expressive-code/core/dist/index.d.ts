...
export { Parent } from 'hast-util-to-html/lib/types';
...
declare class ExpressiveCodeTheme implements Omit<ThemeRegistration, 'type' | 'colors' | 'settings'> {
     ...
     * Returns the same `ExpressiveCodeTheme` instance to allow chaining.
     */
    ensureMinSyntaxHighlightingColorContrast(minContrast?: number): this;
    /**
...
declare class ExpressiveCodeEngine implements ResolvedExpressiveCodeEngineConfig {
    ...
    render(input: RenderInput, options?: RenderOptions): Promise<{
        renderedGroupAst: hast_util_to_html_lib_types.Parent;
...
interface ExpressiveCodeHookContext extends ResolverContext {
    codeBlock: ExpressiveCodeBlock;
 ...
 */
interface PostprocessRenderedLineContext extends ExpressiveCodeHookContext {
    /**
 ...
 * and allows modifying the rendered output.
 */
interface PostprocessRenderedBlockContext extends ExpressiveCodeHookContext {
    /**
 ...
 */
declare function runHooks<HookType extends keyof ExpressiveCodePluginHooks>(key: HookType, plugins: readonly ExpressiveCodePlugin[], runner: (hook: {
    hookName: HookType;
...
declare function annotationSortFn(a: ExpressiveCodeAnnotation, b: ExpressiveCodeAnnotation): number;
...
declare class InlineStyleAnnotation extends ExpressiveCodeAnnotation {
    ...
    render({ nodesToTransform, styleVariants }: AnnotationRenderOptions): Parent[];
}
 ...
 */
declare function setProperty(node: Element, propertyName: string, value: string | string[]): void;
/**
...
type ReplaceDelimitedValuesMatch = {
    fullMatch: string;
    key: string;
    value: string;
...
type ReplaceDelimitedValuesSyntax = {
    /**
...
declare function replaceDelimitedValues(
/** The input string. */
input: string, 
/**
 ...
 */
syntax?: ReplaceDelimitedValuesSyntax): string;
/**
 ...
 */
declare function getGroupIndicesFromRegExpMatch(match: RegExpMatchArray): ([start: number, end: number] | null)[];
/**
...
export { AnnotationBaseOptions, AnnotationRenderOptions, AnnotationRenderPhase, AnnotationRenderPhaseOrder, AttachedPluginData, BaseStylesResolverFn, ChromaticRecolorTarget, ExpressiveCodeAnnotation, ExpressiveCodeBlock, ExpressiveCodeBlockOptions, ExpressiveCodeEngine, ExpressiveCodeEngineConfig, ExpressiveCodeHook, ExpressiveCodeHookContext, ExpressiveCodeInlineRange, ExpressiveCodeLine, ExpressiveCodePlugin, ExpressiveCodePluginHookName, ExpressiveCodePluginHooks, ExpressiveCodePluginHooks_BeforeRendering, ExpressiveCodePluginHooks_Rendering, ExpressiveCodeTheme, ExpressiveCodeThemeInput, InlineStyleAnnotation, InlineStyleAnnotationOptions, JsModulesResolverFn, PluginDataTarget, PluginStyleSettings, PluginTexts, PostprocessRenderedBlockContext, PostprocessRenderedBlockGroupContext, PostprocessRenderedLineContext, ReplaceDelimitedValuesMatch, ReplaceDelimitedValuesSyntax, ResolvedExpressiveCodeEngineConfig, ResolvedStyleSettingsByPath, ResolverContext, StyleOverrides, StyleResolverFn, StyleSettingPath, StyleSettings, StyleValueOrValues, StyleVariant, ThemeSetting, UnresolvedPluginStyleSettings, UnresolvedStyleSettings, UnresolvedStyleValue, addClassName, annotationSortFn, changeAlphaToReachColorContrast, changeLuminanceToReachColorContrast, chromaticRecolor, codeLineClass, cssVarReplacements, darken, ensureColorContrastOnBackground, formatTemplate, getClassNames, getColorContrast, getColorContrastOnBackground, getCssVarName, getGroupIndicesFromRegExpMatch, getLuminance, getStableObjectHash, kebabCase, lighten, mix, multiplyAlpha, onBackground, replaceDelimitedValues, resolveStyleVariants, runHooks, setAlpha, setLuminance, setProperty, stableStringify, toHexColor, toRgbaString, validateExpressiveCodeAnnotation };
