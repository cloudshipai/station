import { PluginTexts, ExpressiveCodePlugin, AttachedPluginData } from '@expressive-code/core';
...
declare const pluginFramesData: AttachedPluginData<PluginFramesData>;

export { FramesStyleSettings, LanguageGroups, LanguagesWithFencedFrontmatter, PluginFramesData, PluginFramesOptions, pluginFrames, pluginFramesData, pluginFramesTexts };
