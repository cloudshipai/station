import { ExpressiveCodePlugin, AttachedPluginData } from '@expressive-code/core';
...
interface PluginTextMarkersData {
    plaintextTerms: {
...
declare const pluginTextMarkersData: AttachedPluginData<PluginTextMarkersData>;

export { PluginTextMarkersData, TextMarkersStyleSettings, pluginTextMarkers, pluginTextMarkersData };
