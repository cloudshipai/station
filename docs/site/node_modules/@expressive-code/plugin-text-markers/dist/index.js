...
// src/annotations.ts
import { addClassName, ExpressiveCodeAnnotation, setProperty } from "@expressive-code/core";
...
var TextMarkerAnnotation = class extends ExpressiveCodeAnnotation {
  ...
  renderFullLineMarker({ nodesToTransform }) {
    return nodesToTransform.map((node) => {
      ...
      if (this.label) {
        setProperty(node, "data-marker-label", this.label);
      }
      return node;
    });
  }
          ...
          for (const annotation of annotations) {
            ...
            if (fullLineMarker) {
              if (MarkerTypeOrder.indexOf(annotation.markerType) < MarkerTypeOrder.indexOf(fullLineMarker.markerType))
                continue;
              if (AnnotationRenderPhaseOrder.indexOf(annotation.renderPhase) < AnnotationRenderPhaseOrder.indexOf(fullLineMarker.renderPhase))
                continue;
            }
...
var pluginTextMarkersData = new AttachedPluginData(() => ({ plaintextTerms: [], regExpTerms: [] }));
export {
  pluginTextMarkers,
