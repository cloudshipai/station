...
type RemarkExpressiveCodeOptions = Omit<ExpressiveCodeConfig, 'themes'> & {
    /**
...
type RemarkExpressiveCodeDocument = {
    /**
     * The full path to the source file containing the code block.
     */
    sourceFilePath?: string | undefined;
};
type RemarkExpressiveCodeRenderer = {
    ec: ExpressiveCode;
    baseStyles: string;
    themeStyles: string;
    jsModules: string[];
 ...
 */
declare function createRenderer(options?: RemarkExpressiveCodeOptions): Promise<RemarkExpressiveCodeRenderer>;
declare const remarkExpressiveCode: Plugin<[RemarkExpressiveCodeOptions] | unknown[], Root>;

export { RemarkExpressiveCodeDocument, RemarkExpressiveCodeOptions, RemarkExpressiveCodeRenderer, ThemeObjectOrShikiThemeName, createRenderer, remarkExpressiveCode as default };
