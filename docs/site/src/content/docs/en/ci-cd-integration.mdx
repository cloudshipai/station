...
This generates detailed security analysis results:
<img src="/station/run-details.png" alt="Agent Execution Results" style="cursor: pointer; border: 1px solid #ccc; border-radius: 8px;" onclick="window.open(this.src, '_blank')" />
