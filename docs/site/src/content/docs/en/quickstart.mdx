...
# Install DevOps Security Bundle via UI or API
```

**Via Station UI** (recommended):
![Install Bundle Interface](/install-bundle.png)
...
![Sync Ready Interface](/sync-ready.png)

```bash
stn sync
```

![Sync Completed](/sync-finished.png)
...
![MCP Servers Interface](/mcp-servers.png)
...
![Agent Run Details](/run-details.png)
