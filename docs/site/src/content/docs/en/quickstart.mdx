...
> **What is Ship?** [Ship](https://github.com/cloudshipai/ship) provides curated MCP tools for Station. The `--ship` flag automatically configures Station with production-ready tools for development workflows.

### 3. Sync and Connect

**Sync your MCP tools and agents:**

<img src="/station/sync-ready.png" alt="Sync Ready Interface" style="cursor: pointer; border: 1px solid #ccc; border-radius: 8px;" onclick="window.open(this.src, '_blank')" />

```bash
stn sync
```

<img src="/station/sync-finished.png" alt="Sync Completed" style="cursor: pointer; border: 1px solid #ccc; border-radius: 8px;" onclick="window.open(this.src, '_blank')" />
...
<img src="/station/mcp-servers.png" alt="MCP Servers Interface" style="cursor: pointer; border: 1px solid #ccc; border-radius: 8px;" onclick="window.open(this.src, '_blank')" />
...
<img src="/station/run-details.png" alt="Agent Run Details" style="cursor: pointer; border: 1px solid #ccc; border-radius: 8px;" onclick="window.open(this.src, '_blank')" />
