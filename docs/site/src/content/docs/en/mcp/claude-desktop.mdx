...
```json
{
  "mcpServers": {
    "station-remote": {
      "url": "https://your-station-server.com:8586/mcp"
    }
  }
}
```
...
XDG_CONFIG_HOME=/opt/station-prod stn serve --mcp-port 8586
XDG_CONFIG_HOME=/opt/station-dev stn serve --mcp-port 8587
```
...
```json
{
  "mcpServers": {
    ...
    "station-remote": {
      "url": "https://remote-station.company.com:8586/mcp"
    },
    "station-docker": {
      "command": "docker",
    ...
    "station-k8s": {
      "url": "https://station-service.namespace.svc.cluster.local:8586/mcp"
    }
  }
}
```
...
# In Claude Desktop config
{
  "mcpServers": {
    "station-remote": {
      "url": "https://remote-server.com:8586/mcp"
    }
  }
}
```
...
```bash
# Check server status
curl -v http://localhost:8586/mcp
