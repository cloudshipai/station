...
- **[Claude Code Setup](/station/en/mcp/claude-code)** - Claude Code integration with skills plugin
- **[Claude Desktop Setup](/station/en/mcp/claude-desktop)** - Detailed Claude Desktop integration
- **[Other MCP Clients](/station/en/mcp/other-clients)** - Cursor, Windsurf, Zed, and custom clients
