...
func (x *ProcessEvent_DataEvent) Reset() {
	*x = ProcessEvent_DataEvent{}
	mi := &file_process_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_process_proto_rawDesc = "" +
	...
	"\n" +
	"SendSignal\x12\x1a.process.SendSignalRequest\x1a\x1b.process.SendSignalResponseB3Z1station/pkg/harness/sandbox/e2b/proto/gen/processb\x06proto3"
...
var file_process_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
...
func file_process_proto_init() {
	...
	file_process_proto_msgTypes[19].OneofWrappers = []any{
		(*ProcessSelector_Pid)(nil),
		(*ProcessSelector_Tag)(nil),
	}
	file_process_proto_msgTypes[23].OneofWrappers = []any{
		(*ProcessEvent_DataEvent_Stdout)(nil),
		(*ProcessEvent_DataEvent_Stderr)(nil),
		(*ProcessEvent_DataEvent_Pty)(nil),
	}
	file_process_proto_msgTypes[24].OneofWrappers = []any{}
	type x struct{}
